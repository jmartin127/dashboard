...
func (c *weatherClient) GetCurrentWeather(ctx context.Context, in *GetCurrentWeatherRequest, opts ...grpc.CallOption) (*GetCurrentWeatherReply, error) {
	...
	err := c.cc.Invoke(ctx, "/jmartin127.weather.v1.Weather/GetCurrentWeather", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Weather_GetCurrentWeather_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jmartin127.weather.v1.Weather/GetCurrentWeather",
	}
...
var Weather_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "jmartin127.weather.v1.Weather",
	...
	Metadata: "jmartin127/weather/v1/weather.proto",
}
